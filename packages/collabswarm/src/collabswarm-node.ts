...
import { addBootstrapAddr, addSwarmAddr, CollabswarmConfig, DEFAULT_CONFIG } from "./collabswarm-config";
...
export class CollabswarmNode<DocType, ChangesType, ChangeFnType, MessageType extends CRDTSyncMessage<ChangesType>> {
  ...
  public async start() {
    ...
    if (websocketAddress) {
      clientConfig = addBootstrapAddr(clientConfig, websocketAddress.toString());
    }

...
export interface AuthProvider<PrivateKey, PublicKey, DocumentKey=string> {
  ...
  encrypt(data: Uint8Array, documentKey: DocumentKey): Promise<EncryptionResult>;
  decrypt(data: Uint8Array, documentKey: DocumentKey, iv?: Uint8Array): Promise<Uint8Array>;
}

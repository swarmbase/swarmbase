...
## See it sync — right here

Two independent replicas, one encrypted document. Add todos on either side,
then take the peers offline, edit both concurrently, and reconnect to watch
the changes merge without conflicts.

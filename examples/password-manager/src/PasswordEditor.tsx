...
export function PasswordEditor({passwordId, collabswarm, upsertPasswordStub}: {
  passwordId?: string;
  ...
  const [doc, changeDoc] = useCollabswarmDocumentState(collabswarm, `/passwords/${passwordId}`);

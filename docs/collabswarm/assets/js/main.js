  ...
  (function (a, b) {
    ...
    return (
      (n.noConflict = function (b) {
        return (
          a.$ === n && (a.$ = Mc), b && a.jQuery === n && (a.jQuery = Lc), n
        );
      }),
  ...
  !(function (search) {
      ...
      if (loadingState == SearchLoadingState.Idle && !search.data) {
        ...
        try {
          (search.data = window.searchData),
            (index = lunr.Index.load(search.data.index)),
    ...
    function updateResults() {
      ...
      if (loadingState === SearchLoadingState.Ready) {
        ...
        for (
          var _b = 0, priorityResults_1 = priorityResults;
          _b < priorityResults_1.length;
          _b++
        ) {
        ...
        for (
          var _c = 0, otherResults_1 = otherResults;
          _c < otherResults_1.length;
          _c++
        ) {
...
!(function (typedoc) {
  ...
  (typedoc.transition = (function (tuples) {
    for (var name_2 in tuples)
      if (
        tuples.hasOwnProperty(name_2) &&
        void 0 !== document.body.style[name_2]
      )
